...
describe('reducerDestinosViajes', () => { //Feature
    it('should reduce init data', () => { //Cases
        //Setup del Test (Given)
        const prevState: DestinosViajesState = intializeDestinosViajesState();
        const action: InitMyDataAction = new InitMyDataAction(['destino 1', 'destino 2']);
        //Action 'Se envia al reducer y nos retorna un estado nuevo' (When)
